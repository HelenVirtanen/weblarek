...
`postOrder()` - на эндпоинт /order/ - в теле данные о покупателе и выбранных товарах (использует метод post класса Api)

P.S. В интерфейсе IOrder пока указаны временные данные!
