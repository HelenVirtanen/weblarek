...
1) Модальные окна: 
* ModalCart - корзина
* ModalProduct - детали карточки товара 
* ModalPaymentForm - форма с выбором оплаты и адреса 
...
1) ProductCard - карточка товара (в каталоге, в модальном окне, в корзине)
2) From - форма (выбор оплаты и адреса, контактные данные)
