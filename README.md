...
* PaymentForm - форма с выбором оплаты и адреса 
* ContactsForm - форма с контактными данными
* ModalSuccessOrdered - подтверждение успешного заказа

2) Gallery - Каталог товаров
3) Header - Корзина с счетчиком товаров (в хедере)
4) CardBasket - Карточка товара в корзине (как пункт списка)
5) CardCatalog - Карточка товара в каталоге

Переиспользуемые сущности (базовые абстрактные классы): 
1) Card - карточка товара (в каталоге, в модальном окне, в корзине)
2) Form - форма (выбор оплаты и адреса, контактные данные)
